...
Реализуйте полноценный проект с помощью утилиты vite. Для `item` можете использовать либо тип `object`, либо вынести `item` в класс и использовать `instanceOf`.

Используйте данный в задании CSS для стилизации.
